    ...
    try {
      if (throwable == null) {
        ...
        try {
          ...
          if (!queued) {
            try {
              nexus.io.tio.core.Tio.close(channelContext, null, "proxy handshake failed: " + ex.getMessage(),
        ...
        if (!queued) {
          nexus.io.tio.core.Tio.close(channelContext, null, "No reconnect needed, close this connection", true,
