...
public class ConfigUtils {
   ...
   * @author: tanyaowu
   */
  public static <T extends PropertiesConfiguration> T initConfig(String filename, String encoding, T t)
      throws FileNotFoundException {
   ...
   * @author: tanyaowu
   */
  public static PropertiesConfiguration initConfig(String filename1, String filename2, String encoding)
      throws FileNotFoundException {
   ...
   */
  public static PropertiesConfiguration initConfig(String filename1, String filename2, String encoding,
      char listDelimiter) throws FileNotFoundException {
   ...
   * @author: tanyaowu
   */
  public static <T extends PropertiesConfiguration> T initConfig(String filename1, String filename2, String encoding,
      T t) throws FileNotFoundException {
   ...
   */
  public static <T extends PropertiesConfiguration> T initConfig(String filename1, String filename2, String encoding,
      char listDelimiter, T t) throws FileNotFoundException {
