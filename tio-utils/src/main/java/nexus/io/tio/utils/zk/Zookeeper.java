...
public class Zookeeper {
  ...
  public static void init(String address, ClientDecorator clientDecorator) throws Exception {
    ...
    Builder builder = CuratorFrameworkFactory.builder().connectString(address).connectionTimeoutMs(15 * 1000)
  ...
  public static void addPathChildrenCacheListener(String path, PathChildrenCacheListener pathChildrenCacheListener)
      throws Exception {
